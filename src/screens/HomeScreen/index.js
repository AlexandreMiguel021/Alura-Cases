...
export default function HomeScreen() {
  return (
    <Box>
      <Head>
        <title>Home - Alura Casaes Campanha</title>
      </Head>
      <Box
        as='main'
        styleSheet={{
            ...
            <Box>
              ...
              >
                ...
                >
                  ...
                  >
                    Aqui você vai ter acesso a discussões avançadas:
                    as principais decisões sobre arquitetura e design
                    de sistemas. Aprenda através das descobertas que
                    as principais empresas de tecnologia enfrentam!
                  </Text>
                  <Text
                    as='p'
                    styleSheet={{
